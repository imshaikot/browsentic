...
function renderNotes(version, commits, prevTag) {
  ...
  lines.push(
    ...
    'everything, Node included. If macOS says it could not verify the app, press **Done**, then **System Settings →',
    'Privacy & Security → Open Anyway**, or run `xattr -dr com.apple.quarantine /Applications/Browsentic.app`.',
    '',
    '**Any platform**',
    '',
    '```sh',
