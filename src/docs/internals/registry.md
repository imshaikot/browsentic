...
order: 2
isIndex: false
permalink: "/docs/internals/registry/"
sourceUrl: "https://github.com/imshaikot/browsentic/blob/main/docs/internals/registry.md"
---
![One array compiled into two bundles, and what happens when the two halves drift](/docs/assets/registry.png)
...
The fix is always to rebuild both halves — see [guide/maintenance.md](/docs/guide/maintenance/#updating).
...
the source of truth that [reference/tools.md](/docs/reference/tools/) is kept in step with.

---

## Next

**[Request path →](/docs/internals/request-path/)** — a tool call reaching the page.

Adding one: [Contributing § Adding a capability](/docs/internals/contributing/#adding-a-capability).
