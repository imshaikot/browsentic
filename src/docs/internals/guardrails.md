...
order: 6
isIndex: false
permalink: "/docs/internals/guardrails/"
sourceUrl: "https://github.com/imshaikot/browsentic/blob/main/docs/internals/guardrails.md"
---
![decide() and its three outcomes, over the four declarative mechanisms](/docs/assets/guardrails.png)
...
A [site-mapping run](/docs/internals/subsystems/#site-maps) is gated harder still, and the gate lives in the daemon
...
**[Subsystems →](/docs/internals/subsystems/)**

User-facing view of all this: [guide/approvals.md](/docs/guide/approvals/).
