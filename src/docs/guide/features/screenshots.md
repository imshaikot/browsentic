...
pageKey: docs
title: "Screenshots"
seoTitle: "Screenshots — Browsentic features"
description: "Screenshots. Full-page capture has to scroll the page in viewport-sized steps and wait out the browser's two-captures-per-second limit between each. Ask for…"
deck: ""
docsPath: "guide/features/screenshots.md"
section: "guide/features"
sectionLabel: "Features"
sectionOrder: 2
order: 3
isIndex: false
permalink: "/docs/guide/features/screenshots/"
sourceUrl: "https://github.com/imshaikot/browsentic/blob/main/docs/guide/features/screenshots.md"
---
```
...
Change where with `screenshotDir` in [config](/docs/guide/configuration/).
...
- [reference/tools.md § page_screenshot](/docs/reference/tools/#page-screenshot) — every parameter
- [Theming](/docs/guide/features/theming/) — if the goal is "this page is unreadable", measuring beats capturing
- [internals/subsystems.md](/docs/internals/subsystems/) — how tiles are stitched and who writes the file
