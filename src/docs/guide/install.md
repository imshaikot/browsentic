...
pageKey: docs
title: "Install"
seoTitle: "Install — Browsentic user guide"
description: "Browsentic is two halves: a browser extension and a local daemon. One command installs both. Then pair them. There is no account, no API key and no cloud…"
deck: "Browsentic is two halves: a browser extension and a local daemon. One command installs both. Then pair them."
docsPath: "guide/install.md"
section: "guide"
sectionLabel: "User guide"
sectionOrder: 1
order: 0
isIndex: false
permalink: "/docs/guide/install/"
sourceUrl: "https://github.com/imshaikot/browsentic/blob/main/docs/guide/install.md"
---
...
- **An agent CLI is only needed for the side panel.** It is what the daemon spawns to reason about
  ...
  and no agent CLI is required. See [Choosing an agent](/docs/guide/agents/).
...
pick up the new build. See [Maintenance](/docs/guide/maintenance/).
...
**[Pair your browser →](/docs/guide/pair/)** — the extension connects to nothing until you do.
