...
description: "Browsentic is two halves — a browser extension and a local daemon. This page builds both and loads the extension. Then pair them."
deck: "Browsentic is two halves — a browser extension and a local daemon. This page builds both and loads the extension. Then pair them."
...
[Maintenance](/docs/guide/maintenance/).
