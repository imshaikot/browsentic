...
- **The agent is not part of this project.** Browsentic spawns whichever agent CLI you chose —
  Claude Code, Codex, Antigravity, Mistral Vibe, Grok Build, Cursor CLI, Qwen Code or OpenCode —
  and contains each as well as its own flags allow, but their behaviour,
