...
The honest boundaries. Read this before deciding where Browsentic fits.
...
[approval gate](approvals.md) on for anything consequential, and be deliberate about running
...
nothing is asking you first. See [MCP clients](mcp-clients.md).
...
- [Troubleshooting](troubleshooting.md) — when one of these bites
