...
What Browsentic does at a "verify you are human" block, and — more importantly — what it does not.
...
Ticking the checkbox is [gated for approval](../approvals.md) by default, because it acts on
